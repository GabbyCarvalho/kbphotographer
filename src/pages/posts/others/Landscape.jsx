...
export default function Landscape() {
    return(
        <>
        <PicTimePost
        embedCode={`<script> const searchread_65c5bd14d18b8817bcccdecb = Landscape | Nature Photography
Colorado Landscapes
January 1, 2024
